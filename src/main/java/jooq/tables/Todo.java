...
public class Todo extends TableImpl<TodoRecord> {
    ...
    private static final long serialVersionUID = 1388296013;
     ...
     */
    public final TableField<TodoRecord, Long> ID = createField("ID", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("(NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_65565CE4_417E_4B1D_A294_34CA6F0CCECB)", org.jooq.impl.SQLDataType.BIGINT)), this, "");
